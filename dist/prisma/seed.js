    ...
    const chapters = [
        {
            ...
            period: "1958",
            order: 1,
            content: "Le 2 octobre 1958, la Guinée devient le premier pays africain à dire « NON » au référendum proposé par le général de Gaulle. Ce choix ouvre la voie à son indépendance totale. Ahmed Sékou Touré devient le premier président du pays.",
            questions: [
                {
        ...
        },
        {
            ...
            period: "1882–1898",
            order: 2,
            content: "Samory Touré a été l’un des plus grands résistants ouest-africains face à la colonisation française. Chef du Wassoulou, il a mené une résistance héroïque pendant plus de 16 ans.",
            questions: [
                {
        ...
        },
        {
            ...
            period: "1725–1896",
            order: 3,
            content: "Le Fouta-Djalon fut un État théocratique dirigé par des Almamy. C’est l’un des royaumes les plus influents d’Afrique de l’Ouest avec un système politique bien organisé et des savants religieux prestigieux.",
            questions: [
                {
        ...
        },
        {
            ...
            order: 4,
            content: "L’Empire du Mali, fondé par Soundiata Keïta, est l'un des plus grands empires d’Afrique de l’Histoire. Mansa Musa, l’un de ses empereurs, reste célèbre comme l’un des hommes les plus riches de tous les temps.",
            questions: [
                {
        ...
        },
        {
            ...
            period: "1984–2008",
            order: 5,
            content: "Après le décès de Sékou Touré, un groupe militaire prend le pouvoir en 1984 dirigé par le colonel Lansana Conté. Il dirige la Guinée pendant plus de deux décennies, jusqu’à sa mort en 2008.",
            questions: [
                {
